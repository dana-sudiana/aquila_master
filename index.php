...
<body class="theme-teal">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">INFORMASI WARGA GRAHA AQUILA  </a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="images/member-2.jpg" width="70" height="70" alt="User" />
                </div>
                ...
                <ul class="list">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                            ...
                            <span>DATA BASE RUMAH </span>
                        </a>
                        <ul class="ml-menu">

                            <li>
                                    <a href="crud_aquila/crud_aquila/index.php">
                                    <i class="material-icons">person</i>
                                    <span>UPDATE DATA RUMAH WARGA</span>
                                </a>
                            </li>
                           
                            <li>
                                    <a href="crud_aquila/crud_aquila/cetak_rumah.php">    
                                    <i class="material-icons">picture_as_pdf</i>
                                    <span>TABEL RUMAH ( MONITOR )</span>
                                </a>
                            </li> 
                            <li>
                           
                                    <a href="crud_aquila/crud_aquila/cetak_rumah1.php">    
                                    <i class="material-icons">picture_as_pdf</i>
                                    <span>TABEL RUMAH (PRINTOUT)</span>
                                </a>
                            </li> 
                            <li>
                           
                                    <a href="crud_aquila/crud_aquila/export1.php">    
                                    <i class="material-icons">picture_as_pdf</i>
                                    <span>TABEL RUMAH XLS</span>
                                    </a>
                            </li> 
